...
namespace Contoso.VisualStudio
{
    internal static class VsHelper
    {
        ...
        public static ProjectItem FindProjectItem(EnvDTE.Project project, string file)
        {
            return FindProjectItem(project.ProjectItems, file);
        }

        public static ProjectItem FindProjectItem(EnvDTE.ProjectItems items, string file)
        {
