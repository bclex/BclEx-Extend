...
{
    /// <summary>
    /// Contains extension method for performing dynamic <b>LINQ</b> queries.
    /// </summary>
    public static class DynamicQueryable
    {
        ...
        /// <param name="predicate">A string representation of a condition used to test each element.</param>
        ...
        {
            return (IQueryable<TSource>)Where((IQueryable)source, predicate, values);
        }

        /// <summary>
        /// Filters a sequence of values based on a predicate.
        /// </summary>
        /// <param name="source">An <see cref="System.Collections.IEnumerable"/> to filter.</param>
        /// <param name="predicate">A string representation of a condition used to test each element.</param>
        /// <param name="values">An array of parameter values.</param>
        /// <returns>An <see cref="System.Collections.IEnumerable"/> that contains elements from the input sequence that satisfy the condition.</returns>
        ...
        /// <param name="selector">A string representation of a transform function to apply to each element.</param>
        /// <param name="values">An array of parameter values.</param>
        /// <returns></returns>
        ...
        /// <param name="ordering">A string representation of the ordering clause.</param>
        /// <param name="values">An array of parameter values.</param>
        /// <returns>An <see cref="IOrderedEnumerable{TElement}"/> whose elements are sorted according to a ordering clause.</returns>
        public static IQueryable<TSource> OrderBy<TSource>(this IQueryable<TSource> source, string ordering, params object[] values)
        {
            return (IQueryable<TSource>)OrderBy((IQueryable)source, ordering, values);
        }
        ...
        /// <param name="ordering">A string representation of the ordering clause.</param>
        /// <param name="values">An array of parameter values.</param>
        /// <returns>An <see cref="IOrderedEnumerable{TElement}"/> whose elements are sorted according to 
        /// a ordering clause.
        /// </returns>
        ...
        /// <returns>An <see cref="System.Collections.IEnumerable"/> that contains the specified number of 
        ...
        /// </summary>
        /// <param name="source">An <see cref="System.Collections.IEnumerable"/> to return elements from.</param>
        /// <param name="count">The number of elements to skip before returning the remaining elements.</param>
        /// <returns>An <see cref="System.Collections.IEnumerable"/> that contains the elements that occur 
        ...
        /// <summary>
        /// Groups the elements of a sequence according to a specified key selector function and projects the 
        /// elements for each group by using a specified function.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <param name="keySelector">A string representation of a function to extract the key for each element.</param>
        /// <param name="elementSelector">A string representation of a function to map each source element to an 
        /// element in the <see cref="IGrouping{TKey, TElement}"/>.</param>
        /// <param name="values">An array of parameter values.</param>
        /// <returns>An <see cref="IEnumerable{IGrouping}"/> in C# or IEnumerable(Of IGrouping(Of TKey, TElement)) 
        /// in Visual Basic where each <see cref="IGrouping{TKey, TElement}"/> object contains a collection of objects 
        /// of type TElement and a key.
        /// </returns>
    ...
    /// <summary>
    /// Represents a property created dynamically.
    /// </summary>
    ...
    /// <summary>
    /// Provides methods for constructing dynamic expressions.
    /// </summary>
    public static class DynamicExpression
    {
        /// <summary>
        /// Constructs an <see cref="Expression"/> from the specified string and optional parameter values.
        /// </summary>
        /// <param name="resultType">The type the construct expression will represent.</param>
        /// <param name="expression">A string representation of the expression.</param>
        /// <param name="values">An array of parameter values.</param>
        /// <returns>An <see cref="Expression"/> the represents the <paramref name="expression"/> parameter.</returns>
        public static Expression Parse(Type resultType, string expression, params object[] values)
        {
            var parse = new ExpressionParser(null, expression, values);
            return parse.Parse(resultType);
        }

        /// <summary>
        /// Constructs a <see cref="LambdaExpression"/> from the specified string and optional parameter values.
        /// </summary>
        /// <param name="itType">The type of the object that the expression is operating against.</param>
        /// <param name="resultType">The type the result of the expression will return.</param>
        /// <param name="expression">A string representation of the expression.</param>
        /// <param name="values">An array of parameter values.</param>
        /// <returns>A <see cref="LambdaExpression"/> that represents the <paramref name="expression"/> parameter.</returns>
        public static LambdaExpression ParseLambda(Type itType, Type resultType, string expression, params object[] values) { return ParseLambda(new[] { Expression.Parameter(itType, string.Empty) }, resultType, expression, values); }

        /// <summary>
        /// Constructs a <see cref="LambdaExpression"/> from the specified string, an array of <see cref="ParameterExpression"/> values, and optional parameter values.
        /// </summary>
        /// <param name="parameters">An array of parameters for the lambda expression.</param>
        /// <param name="resultType">The type the result of the expression will return.</param>
        /// <param name="expression">A string representation of the expression.</param>
        /// <param name="values">An array of parameter values.</param>
        /// <returns>A <see cref="LambdaExpression"/> that represents the <paramref name="expression"/> parameter.</returns>
        ...
        /// <summary>
        /// Constructs a <see cref="Expression{T}"/> from the specified string and optional parameter values.
        /// </summary>
        /// <typeparam name="T">The type of the lambda expression.</typeparam>
        /// <typeparam name="TResult">The type of the result of the lambda expression.</typeparam>
        /// <param name="expression">A string representation of the lambda expression.</param>
        /// <param name="values">An array of parameter values.</param>
        /// <returns>A <see cref="LambdaExpression"/> that represents the <paramref name="expression"/> parameter.</returns>
        public static Expression<Func<T, TResult>> ParseLambda<T, TResult>(string expression, params object[] values) { return (Expression<Func<T, TResult>>)ParseLambda(typeof(T), typeof(TResult), expression, values); }

        /// <summary>
        /// Creates a dynamic data class with the specified properties.
        /// </summary>
        /// <param name="properties">An array of properties that the class will possesses.</param>
        /// <returns>The type of the dynamic data class.</returns>
        public static Type CreateClass(params DynamicProperty[] properties) { return ClassFactory.Instance.GetDynamicClass(properties); }

        /// <summary>
        /// Creates a dynamic data class with the specified properties.
        /// </summary>
        /// <param name="properties">An <see cref="IEnumerable{DynamicProperty}"/> containing the properties that the class 
        /// will possesses.
        /// </param>
        /// <returns>The type of the dynamic data class.</returns>
    ...
    internal class ClassFactory
    {
...
#endif
            try { _module = assembly.DefineDynamicModule("Module"); }
            finally
            {
#if ENABLE_LINQ_PARTIAL_TRUST
        ...
        Type CreateDynamicClass(DynamicProperty[] properties)
        {
            ...
            finally { _rwLock.DowngradeFromWriterLock(ref cookie); }
        }
        ...
        FieldInfo[] GenerateProperties(TypeBuilder tb, DynamicProperty[] properties)
        {
            ...
            for (var i = 0; i < properties.Length; i++)
            {
                ...
                var mbGet = tb.DefineMethod("get_" + dp.Name, MethodAttributes.Public | MethodAttributes.SpecialName | MethodAttributes.HideBySig, dp.Type, Type.EmptyTypes);
                var genGet = mbGet.GetILGenerator();
                genGet.Emit(OpCodes.Ldarg_0);
                genGet.Emit(OpCodes.Ldfld, fb);
                genGet.Emit(OpCodes.Ret);
                var mbSet = tb.DefineMethod("set_" + dp.Name, MethodAttributes.Public | MethodAttributes.SpecialName | MethodAttributes.HideBySig, null, new Type[] { dp.Type });
        ...
        {
            var mb = tb.DefineMethod("Equals", MethodAttributes.Public | MethodAttributes.ReuseSlot | MethodAttributes.Virtual | MethodAttributes.HideBySig, typeof(bool), new Type[] { typeof(object) });
    ...
    /// <summary>
    /// The exception thrown when a parsing error is encountered.
    /// </summary>
    public sealed class ParseException : Exception
    {
        ...
        /// <summary>
        /// Gets the position the parsing error occured.
        /// </summary>
        /// <value>The position of the parsing error.</value>
...
#pragma warning restore 0219
    ...
    static class Res
    {
        ...
        public const string MethodIsVoid = "Method '{0}' in type '{1}' does not return left value";
