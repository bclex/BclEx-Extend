...
namespace System.Text.Lalr
{
    internal class Config
    {
        ...
        internal class KeyComparer : IComparer<Config>
        {
        ...
        internal class KeyEqualityComparer : IEqualityComparer<Config>
        {
        ...
        internal class ListKeyEqualityComparer : IEqualityComparer<List<Config>>
        {
